...
- [#20](https://github.com/ijlee2/sublime-syntax-definition-template-tag/pull/20) Updated README ([@ijlee2](https://github.com/ijlee2))

## 3.0.0

### Major Changes

- [#19](https://github.com/ijlee2/sublime-syntax-definition-template-tag/pull/19) Reverted to having a single syntax definition for gjs and gts files ([@ijlee2](https://github.com/ijlee2))

## 2.0.2

### Patch Changes

- [#18](https://github.com/ijlee2/sublime-syntax-definition-template-tag/pull/18) Updated README ([@ijlee2](https://github.com/ijlee2))
